...
public final class Excluder implements TypeAdapterFactory, Cloneable {
  ...
  private boolean disableOptionalAnnotation;
  ...
  public Excluder disableOptionalAnnotation() {
    Excluder result = clone();
    result.disableOptionalAnnotation = true;
    return result;
  }

  public boolean getDisableOptionalAnnotation() {
    Excluder result = clone();
    return result.disableOptionalAnnotation;
  }
